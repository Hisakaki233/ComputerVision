...
def part_2a():
    ...
    for i in range(5):
        ...
        # TODO: find which of these labels match ytest and report its accuracy
        boost_accuracy = 100 * sum([1 if y_pred[i] == ytest[i] else 0 for i in range(len(ytest))]) / len(ytest)
...
def part_4_c():
    ...
    VJ.faceDetection(image, outputDir=OUTPUT_DIR, filename="ps6-4-c-1")
